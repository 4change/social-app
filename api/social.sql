...
CREATE TABLE `comments` (
  ...
  PRIMARY KEY (`id`),
  KEY `commentsUserId` (`userId`),
  KEY `comments_FK_1` (`postId`),
  CONSTRAINT `commentsUserId` FOREIGN KEY (`userId`) REFERENCES `users` (`id`) ON DELETE CASCADE ON UPDATE CASCADE,
...
-- Dump completed on 2023-07-14 14:41:34
